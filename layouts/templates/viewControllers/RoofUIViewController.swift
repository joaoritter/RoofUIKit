...
class RoofUIViewController: UIViewController, BaseViewController, ApplicationStateListener, NavigationButtonManager, SwipeToDismissController {
    ...
    func handleSwipe(_ gesture: UIPanGestureRecognizer) {
        closeActionFor(gesture: gesture, leftBarButtonType: leftButtonType)
        backActionFor(gesture: gesture, leftBarButtonType: leftButtonType)
    }
}

extension RoofUIViewController: UIGestureRecognizerDelegate {
